...
const Header = () => {
  ...
  return (
    <nav id="header" className="fixed w-full z-[999] top-0 text-white">
      <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        <div className="pl-4 flex items-center">
          <a className="toggleColour text-gray-800 no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
        ...
        <div className="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
          ...
          <div className="flex items-center space-x-4 text-2xl">
            😀
            <span className="text-gray-800 font-medium">Tuấn Lê</span>
          </div>
        </div>
      </div>
